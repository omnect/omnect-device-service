...
mod tests {
    ...
    fn networkd_wait_online_timeout_invalid_input() {
        ...
        unsafe { std::env::set_var("WAIT_ONLINE_SERVICE_FILE_PATH", "") };
        ...
        // TODO: Audit that the environment access only happens in single-threaded code.
        unsafe { std::env::remove_var("WAIT_ONLINE_SERVICE_FILE_PATH") };
        // TODO: Audit that the environment access only happens in single-threaded code.
        unsafe { std::env::remove_var("ENV_FILE_PATH") };
    }
    ...
    fn networkd_wait_online_timeout_ok() {
        ...
        // TODO: Audit that the environment access only happens in single-threaded code.
        unsafe { std::env::set_var("ENV_FILE_PATH", "/tmp/systemd-networkd-wait-online1.env") };
        assert_eq!(
